...
public class TripComp {
    ...
    public static void main(String[] args) {
         ...
         */
         ...
         double newGasPrice = gasPrice/100.0;
         double speed = (double)distance/mpgRating;
         double cost = newGasPrice*speed;
        int wholeCost = (int)cost;

         if (wholeCost != cost) {
            String finalcost = formattedCost(cost);
            System.out.println("The cost of the trip is $" + finalcost + ".");
        }  else{
            System.out.println("The cost of the trip is $" + wholeCost + ".");
