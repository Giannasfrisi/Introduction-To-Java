...
public class StringNode {
    ...
    */
    ...
    StringNode trail = newStr;
    StringNode trav = null;

    while(str.next != null){
        trav = new StringNode(str.next.ch, null);
        trail.next = trav;
        trail = trav;
        str= str.next;
    }
    ...
    public static StringNode insertSorted(StringNode str, char ch) {
       ...
       if (str == null){
           ...
           StringNode insertStr = new StringNode(ch, str);
           insertStr.next = str;
           return insertStr;
       }
       else{
    ...
    public static void printReverse(StringNode str) {
       ...
       char [] printArray = new char[length(str)];
       StringNode trav = str;
       for (int i= 0; i< length(str); i++){
           printArray[i] = trav.ch;
           trav = trav.next;
       }
