...
public class LinkedTree {
    ...
    private void deleteNode(Node toDelete, Node parent) {
        ...
        private static int numLeafNodesInTree(Node node){
            ...
            if (node.left == null && node.right == null){
                ...
                if (node.left != null){
                    numLeafNodesInTree(node.left);
                 }
                if (node.right != null){
                    numLeafNodesInTree(node.right);
                }
            }
            return num; 
    ...
    public static void main(String[] args) {
        ...
        int[] keys2 = {34, 56, 12, 76, 39, 10, 33, 22, 11};
        ...
        System.out.println();
        System.out.println("(1) Testing '34, 56, 12, 76, 39, 10, 33, 22, 11 ");
        LinkedTree tree1 = new LinkedTree();
        System.out.println("empty tree: " + tree1.deleteSmallest());
        System.out.println();

        int[] keys1 = {34, 56, 12, 76, 39, 10, 33, 22, 11};
        ...
        System.out.println("(2) Testing '99,34,56,77,15,25,66,43,13' ");
                LinkedTree tree2 = new LinkedTree();
        System.out.println("empty tree: " + tree2.deleteSmallest());
        System.out.println();

        int[] keys2 = {99,34,56,77,15,25,66,43,13};
        tree2.insertKeys(keys2);
        ...
        System.out.println();
        System.out.println("(1) Testing '99,34,56,77,15,25,66,43,13' ");
        LinkedTree tree3 = new LinkedTree();
        System.out.println(tree3.numLeafNodes());

        int[] keys3 = {99,34,56,77,15,25,66,43,13};
        ...
        System.out.println("--- Testing numLeafNodes ---");
        System.out.println();
        System.out.println("(2) Testing '34, 56, 12, 76, 39, 10, 33, 22, 11' ");
